...
/**
 * Represents a GUI menu for a specific group
 * @param name The name of the menu
 * @param options All options that can be executed with this menu
 * @param group The group this menu belongs too
 * @param bukkitWrapper BukkitWrapper for debugging only
 */
class GroupGuiMenu(override val name: String, options: List<IOption>, override val group: Group, private val bukkitWrapper: BukkitWrapper = BukkitWrapper()) : IGroupMenu, GUIMenu {
    ...
    /**
     * Execute an specific option
     * @param sender The player that executed the option
     * @param position The position of the option
     */
